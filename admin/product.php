            ...
            <fieldset>
                ...
                <table>
                    ...
                    <tr>
                        <td>No. KP</td>
                        <td>
                            <input type="text" name="nokpwarden" required value="<?php echo $row->nokpwarden; ?>" minlenght="12" maxlenght="12">
                        </td>
                    </tr>
    ...
    <table class="table">
        ...
        ?>
            <tr>
                ...
                <td>
                    <a href="index.php?menu=product&edit=<?php echo $row->idwarden; ?>">Edit</a>
